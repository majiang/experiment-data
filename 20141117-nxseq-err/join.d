	...
	foreach (s; 4..17)
		foreach (i; 0..6)
			foreach (genz_c; [1, 2, 4])
			{
				...
				foreach (in_file; [
					File("s%02d-m%02dm%02d-%dgenz%d.csv".format(s,  8, 17, c, i))
				,	File("s%02d-m%02dm%02d-%dgenz%d.csv".format(s, 17, 23, c, i))
			//	,	File("s%02d-m%02dm%02d-%dgenz%d.csv".format(s, 23, 30, c, i))
				])
				{
